...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-10-2022 a las 17:49:03
...
CREATE TABLE `consultas` (
  ...
  `consulta` text CHARACTER SET utf8 NOT NULL
...
(1, 'Ruben', 'Ledesma', 'rubenledesma@hotmail.com', 'Hola mundo'),
(2, 'Lionel', 'Messi', 'liomessi@gmail.com', 'Cuanto falta para que llegue el mundial?');
